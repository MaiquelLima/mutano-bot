...
$onlyIf[$memberExists[$findUser[$message[1]]]==false;{description: \❌・Este usuário não existe no meu banco de dados}{color: #ff0000}]
...
$color[#1ad46d]
$image[$jsonRequest[https://nekos.best/api/v1/kiss;url;error]]
$onlyIf[$memberExists[$findUser[$message[1]]]==false;{description: \❌・This user does not exist in my database}{color: #ff0000}]
