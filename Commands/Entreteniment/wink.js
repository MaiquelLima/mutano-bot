...
$onlyIf[$checkContains[$findUser[$message];$authorID]==false;{description: \❌・Você não pode piscar para si mesmo}{color: #ff0000}]
...
$onlyIf[$checkContains[$findUser[$message];$authorID]==false;{description: \❌・You can't wink at yourself}{color: #ff0000}]
