...
$onlyIf[$checkContains[$findUser[$message];852616816240885760]==true;Meu papai não é gay '-]
...
$onlyIf[$checkContains[$findUser[$message];852616816240885760]==true;My dad is not gay '-]
$endelseif
$endif
    `
})