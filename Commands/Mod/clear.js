...
$onlyIf[$checkContains[$message;1]==true;{description: Você não pode limpar mais de 2 mensagens}{color: #ff0000}]
...
$onlyIf[$checkContains[$message;1]==true;{description: You cannot clear more than 2 messages}{color: #ff0000}]
