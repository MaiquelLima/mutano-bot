module.exports = ({
  ...
  $apiMessage[$channelID;;{footer: Downloads:}{title:Avatar de $username[$findUser[$message;yes]]}{image:$useravatar[$finduser[$message]]}{description:<@$findUser[$message;yes]> Que foto zika meu amigo!  Muito bom gosto :3!
...
$apiMessage[$channelID;;{footer: Downloads:}{title:$username[$findUser[$message;yes]]'s Avatar}{image:$useravatar[$finduser[$message]]}{description:<@$findUser[$message;yes]> What an epic picture!  You have really good taste :3!
