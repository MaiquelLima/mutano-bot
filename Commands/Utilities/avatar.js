module.exports = ({
  ...
  __Downloads__
  [webp\\]($replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$userAvatar[$findUser[$message]?size=4096];gif;webp];png;webp];jpg;webp];jpeg;webp]) | [png\\]($replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$userAvatar[$findUser[$message]?size=4096];gif;png];png;png];jpg;png];jpeg;png];webp;png];?size=2048;?size=4096]) | [jpg\\]($replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$userAvatar[$findUser[$message]?size=4096];gif;jpg];png;jpg];jpg;jpg];jpeg;jpg];webp;jpg];?size=2048;?size=4096]) | [jpeg\\]($replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$userAvatar[$findUser[$message]?size=4096];gif;jpeg];png;jpeg];jpg;jpeg];jpeg;jpeg];webp;jpeg];?size=2048;?size=4096]) | [gif\\]($replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$userAvatar[$findUser[$message]?size=4096];png;gif];jpg;gif];jpeg;gif];webp;gif];?size=2048;?size=4096])
